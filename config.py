...
TG_BOT_TOKEN = os.environ.get(
  "TG_BOT_TOKEN", "5500281723:AAES-ntPU_SwyeI2M1D1kU1zIYluCiEdFEI")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001889031727"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "1316373734"))
...
DB_NAME = os.environ.get("DATABASE_NAME",
                         "fileshahyhyhfghjfghjnfgrexbot68956568")
